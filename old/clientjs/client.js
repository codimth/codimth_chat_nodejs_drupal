...
socket.on('new_borad',function(data){
 boradcast.innerHTML = '<strong>'+data.username+': </strong> write message ' +
	 '<img src="/modules/custom/codimth_chat_nodejs_drupal/assets/write.gif" style="width:25px;height:20px" />';
});
