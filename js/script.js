(function ($, Drupal) {
    Drupal.behaviors.mapsBehavior = {
        attach: function (context, settings) {
            ...
            console.log(settings.current_user);
            var user_id = settings.current_user.uid;
            var username = settings.current_user.name;
            var typingurl = '/modules/custom/codimth_chat_nodejs_drupal/image/typing.gif';
